...
plan: 03
subsystem: api
tags: [anchor, solana, token-2022, lifecycle, admin, access-control]
requires:
  - phase: 01-monorepo-foundation
    provides: monorepo layout, Anchor workspace, and Phase 2 planning inputs
  - phase: 02-layer-1-core-program
    provides: finalized PDA model and real Token-2022 initialization from plans 01 and 02
provides:
...
affects: [02-04, sdk, docs, services]
tech-stack:
  added: []
  patterns: [explicit anchor validation before token CPI, mint-derived stablecoin admin identity, auditable role-change events]
key-files:
  created: [.planning/phases/02-layer-1-core-program/02-03-SUMMARY.md]
  modified:
