...
plan: 01
subsystem: cli
tags: [commander, runtime-config, signer-resolution, sdk-init, json-output]
requires:
  - phase: 05-typescript-sdk
    provides: typed create/load lifecycle and compliance SDK contracts
provides:
...
affects: [06-02, 06-03, services, docs]
tech-stack:
  added: [commander-runtime-bootstrap]
  patterns: [centralized-runtime-resolution, stable-cli-error-envelope]
key-files:
  created:
    - sdk/core/src/cli.ts
