...
tags: [verification, gap-closure, sss-2, anchor-test-validator]
requires:
  - phase: 06-admin-cli-03
    provides: compliance and management CLI implementation plus integration coverage
provides:
...
affects: [phase-06-verification, release-readiness]
tech-stack:
  added: []
  patterns: [evidence-first-verdict, verification-gap-tracking]
key-files:
  created:
