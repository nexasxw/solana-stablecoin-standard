...
plan: 03
subsystem: api
tags: [services, compliance, screening, audit, exports]
requires:
  - phase: 07-01
    provides: shared service envelopes, errors, and idempotency primitives
  - phase: 07-02
    provides: normalized event patterns and finalized-state assumptions for downstream audit traces
provides:
...
affects: [phase-07-backend-services, compliance, indexer, webhook]
tech-stack:
  added: []
  patterns: [review-gating, compliance-mutation-jobs, audit-export-lifecycle, retention-purge]
key-files:
  created:
...
patterns-established:
  - "Compliance mutation commands must flow through screening + optional override resolution before queue admission."
  - "Export jobs follow the shared lifecycle states and preserve full requester/approver/executor identity chain."
