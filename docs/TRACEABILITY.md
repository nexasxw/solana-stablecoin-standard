...
| DOC-02 | Examples in docs match actual SDK and program interfaces. | `docs/SDK.md#initialization-workflows`; `docs/SDK.md#lifecycle-operations`; `docs/COMPLIANCE.md#blacklist-workflows`; `docs/API.md#cli-and-sdk-drift-checks`; `README.md#cli` | `./scripts/sss-token --help && ./scripts/sss-token init --help && ./scripts/sss-token mint --help && ./scripts/sss-token blacklist --help && ./scripts/sss-token seize --help` | `docs/API.md#verification-references`; `.planning/phases/09-documentation/09-03-SUMMARY.md`; `.planning/phases/09-documentation/09-VALIDATION.md` |
